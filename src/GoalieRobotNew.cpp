...
class GoalieRobot
{
  ...
  public:
    ...
    void moveTurtleBot(double alignError, double objDist)
    {
        ...
        // I was considering some rotation, but just kept it stationary instead
        if (objDist > 1.5)
        {
        ...
        // travels 1.95 meters. To try and cut off the ball
        twistMsg.linear.x = 0.65;
